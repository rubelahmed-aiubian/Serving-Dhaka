<?php include "includes/header.php";?>
    <div class="about section bg-grey">
        <div class="container">
            <div class="row">
                <a href="./"><h4>Serving Dhaka</h4></a>
                <p>
                    At Serving Dhaka, accessible from <a href="https://servingdhaka.com">https://servingdhaka.com</a>, one of our main priorities is the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded by
                    Serving Dhaka and how we use it.
                    ...
                    regards to the information that they shared and/or collect in Serving Dhaka. This policy is not applicable
                    ...
                    Log Files
                    Serving Dhaka follows a standard procedure of using log files. These files log visitors when they visit
                    ...
                    Like any other website, Serving Dhaka uses 'cookies'. These cookies are used to store information including
                    ...
                    You may consult this list to find the Privacy Policy for each of the advertising partners of Serving Dhaka.
        
                    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                    used in their respective advertisements and links that appear on Serving Dhaka, which are sent directly to
                    ...
                    Note that Serving Dhaka has no access to or control over these cookies that are used by third-party
                    advertisers.
        
                    Third Party Privacy Policies
                    Serving Dhaka's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                    ...
                    Serving Dhaka does not knowingly collect any Personal Identifiable Information from children under the age
